  ...
  return _createClass(PointerZoom, [{
    ...
    value: function componentDidMount() {
      ...
      var _Magnifier = (0, _magnifier.Magnifier)(this._props),
        ...
        updateZoomImage = _Magnifier.updateZoomImage;
      this.clear = clear;
      ...
      setTimeout(function () {
        _this2.updateVisibility(_this2._props, true);
        _this2.updateZoom(_this2._props, true);
      }, 0);
    }
  }, {
...
PointerZoom.propTypes = {
  ...
  // zoom preview
  placeholderZoomImageSrc: _propTypes["default"].string,
